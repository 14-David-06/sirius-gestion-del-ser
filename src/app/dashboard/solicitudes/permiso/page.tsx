    ...
    <div className="p-8 max-w-2xl mx-auto">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 flex flex-col items-center text-center gap-4">
        ...
        <div className="flex gap-3 mt-2">
          ...
          <Link href="/dashboard/solicitudes" className="px-5 py-2 rounded-xl text-sm text-white font-medium transition-colors" style={{ background: "#1a51a8" }}>Ver mis solicitudes</Link>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        <Link href="/dashboard/solicitudes" className="w-8 h-8 flex items-center justify-center rounded-lg border border-gray-200 hover:bg-gray-50 cursor-pointer transition-colors">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col gap-5">
        {/* Datos del empleado — auto-llenados */}
